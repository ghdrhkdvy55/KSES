...
<button type="button" id="btn_Pop" style="display:none" data-popup-open="bas_code_add" ></button> 
<button type="button" id="btn_Detail" style="display:none" data-popup-open="bas_detailcode_add" ></button> 

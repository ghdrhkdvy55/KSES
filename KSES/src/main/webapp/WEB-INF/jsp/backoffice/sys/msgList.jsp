    		...
    		setGrid : function(gridOption){
    		    ...
    		    grid.jqGrid({
    		        ...
    		        colModel :  [
	    		 	                ...
	    		 	                { label: '회신자',  name:'reqname', index:'reqname', align:'left',   width:'10%'},
	    		 	                { label: '회신 전화번호',  name:'reqphone',  index:'reqphone',        align:'left',   width:'10%'},
	    		 	                { label: '수신자', name:'callname', index:'callname', align:'center', width:'12%' },
	      			                { label: '수신자번호', name:'callphone', index:'callphone', align:'center', width:'12%'},
		      			            { label: '전송구분', name:'result', index:'result', align:'center', width:'12%', 
	      			                  formatter:jqGridFunc.result},
			      			        { label: '문자구분', name:'kind', index:'kind', align:'center', width:'12%', 
	      			                  formatter:jqGridFunc.kind},
	      			                { label: '전송시간',  name:'senttime',         index:'senttime',        align:'left',   width:'10%'},
	      			                { label: '애러코드', name: 'errcode',  index:'errcode',      align:'center',  width: '10%', fixed:true}
    			                ],  //상단면 
    		        rowNum : 10,  //레코드 수

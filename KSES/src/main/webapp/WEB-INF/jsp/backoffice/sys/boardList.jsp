  ...
  <div id="contents">
    ...
    <div class="dashboard">
        ...
        <div class="boardlist">
            ...
            <a href="#" onClick="boardinfo.fn_boardInfo('Ins', '0');" class="right_box blueBtn">등록</a>  
            <div class="clear"></div>
            <div class="whiteBox">
            ...
            <table class="detail_table">
                <tbody>
	                    ...
	                    <tr>
	                        ...
	                        <input type="text"  name="boardNoticeStartDay" style="width:150px" maxlength="8" id="boardNoticeStartDay" />
	                        ~
	                        <input type="text"  name="boardNoticeEndDay"  style="width:150px"  maxlength="8" id="boardNoticeEndDay" />	                        
	                        </td>
	                    </tr>
	                    <tr>
	                    ...
	                    <tr>
	                       <th><span class="redText" id="sp_returntxt">파일 업로드</th>
	                       <td colspan="3">

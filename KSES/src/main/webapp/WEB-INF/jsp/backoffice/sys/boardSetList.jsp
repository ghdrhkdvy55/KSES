    ...
    var jqGridFunc  = {
    		...
    		setGrid : function(gridOption){
    		    ...
    		    grid.jqGrid({
    		        ...
    		        colModel :  [
	    		 	                { label: '게시 아이디', key: true,  name:'board_cd',    index:'board_cd', align:'left',   width:'10%'},
	    		 	                { label: '게시판 타이틀',  name:'board_title', index:'board_title',        align:'left',   width:'10%'},
	    		 	                { label: '권한 설정',  name:'board_author',  index:'board_author',        align:'left',   width:'10%'},
	    		 	                { label: '관련지점', name:'board_center_id', index:'board_center_id', align:'center', width:'12%' },
	      			                { label: '파일업로드', name:'board_file_upload_yn', index:'board_file_upload_yn', align:'center', width:'12%',
	      			                  formatter:jqGridFunc.fileUp},
		      			            { label: '댓글사용', name:'board_cmnt_use', index:'board_cmnt_use', align:'center', width:'12%', 
...
<body>
<form:form name="regist" commandName="regist" method="post" action="/backoffice/bas/holyList.do">
<div class="wrapper">
  <!--// header -->
  <inpu type="hidden" id="mode" name="mode"
  ...
  <div id="contents">
    ...
    <h2 class="title">게시판 등록 관리</h2><div class="clear"></div>
    <!--// dashboard -->
    <div class="dashboard">
        <!--contents-->
        <div class="boardlist">

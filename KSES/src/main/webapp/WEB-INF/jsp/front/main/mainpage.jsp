		...
		<div class="pop_con">
			<a class="button b-close">X</a>
          	<div class="pop_wrap">
                ...
                <p>
                경주사업총괄본부의 승인없이 본 사이트에 게재된 내용 및 자료(사진포함)를 상업적 목적으로 무단 복제, 전송, 출판, 배포, 방송을 금하며 위반시 관계법령에 의거 처벌받게 됩니다.
                <h5>관련법규</h5>
                제10조 (저작권) <br />
                ...
                <br />
                제97조의5 (권리의 침해죄) <br />
                저작재산권 그밖의 이 법에 의하여 보호되는 재산적 권리를 복제·공연·방송·전시·전송·배포·2차적 저작물 작성의 방법으로 침해한 자는 5년 이하의 징역 또는 5천만원 이하의 벌금에 처하거나 이를 병과할 수 있다. [본조신설 2000·1·12] [[시행일 2000·7·1]] <br />
                <br />
                제98조 (권리의 침해죄) <br />
                ...
                4. 제51조 및 제52조(제60조 제3항 또는 제73조의 규정에 의하여 준용되는 경우를 포함한다.)의 규정에 의한 등록을 허위로 한 자 <br /> <br />
                ...
                5. 제92조의 규정에 의하여 침해행위로 보는 행위를 한 자 <br />
                </p>
          	</div>
          	<div class="clear"></div>
      	</div>

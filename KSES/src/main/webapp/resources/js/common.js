...
//추후 변경 예정 
function fn_returnInfo(url, params, _rtnGubun){
    var returnVal = "";
...
//추후 변경 예정 
function fn_returnSerialInfo(url, params, _rtnGubun){
    var returnVal = "";
    uniAjaxSerialAsync(url, params, 
				  function(result) {
...
function uniAjaxSerialAsync(url, param, done_callback, fail_callback){
	var jxFax =  $.ajax({
		        type : 'GET',
		        url : url,
		        async: false,
